...
import me.winflix.vitalcore.citizen.utils.ai.EntityJumpControl;
import me.winflix.vitalcore.citizen.utils.ai.EntityMoveControl;
import me.winflix.vitalcore.citizen.utils.ai.EntityNavigation;
...
public interface MobAI {
    ...
    default void updatePathfindingRange(float range) {
        ((LivingEntity) NMS.getHandle(getBukkitEntity())).getAttribute(Attributes.FOLLOW_RANGE).setBaseValue(range);
    }
    ...
    public static class BasicMobAI implements MobAI {
        ...
        public BasicMobAI(LivingEntity entity) {
            this.entity = entity;
            NMS.setAttribute(entity, Attributes.FOLLOW_RANGE, ((Number) 75F).doubleValue());
