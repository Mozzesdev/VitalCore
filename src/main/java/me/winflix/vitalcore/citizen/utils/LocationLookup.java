...
public class LocationLookup extends BukkitRunnable {
    private final Map<String, PerPlayerMetadata<?>> metadata = new HashMap<>();
    private final Map<UUID, PhTreeF<Player>> worlds = new HashMap<>();
    ...
    public Iterable<Player> getNearbyPlayers(NPC npc) {
        return getNearbyPlayers(npc.getLocation(), 10);
    }
