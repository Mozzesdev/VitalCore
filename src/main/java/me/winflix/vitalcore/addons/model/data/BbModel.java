...
public class BbModel {
    ...
    public static class Animation {
        ...
        /**
         * Representa un keyframe individual dentro de un Animator en una animación de
         * Blockbench.
         */
        public static class Keyframe {
            private final float time;
            private final String channel; // "position", "rotation", "scale", "sound", "particle"
            private final String interpolationType; // "linear", "step", etc.

            // Campos para los datos del keyframe. Solo uno de estos será relevante
            // dependiendo del 'channel'. El deserializador de VC llena estos.
            private Vector3f position;
            private Quaternionf rotation; // Blockbench usa Euler, pero el deserializador de VC lo convierte a
                                          // Quaternionf
            private Vector3f scale;
            private String effect; // Para canales "sound" o "particle"

            /**
             * Constructor para un Keyframe.
             * Los valores específicos (posición, rotación, etc.) se establecen después
             * por el deserializador basado en el canal.
             * 
             * @param time              Tiempo del keyframe.
             * @param channel           Canal al que pertenece este keyframe
             * @param interpolationType Tipo de interpolación.
             */
            public Keyframe(float time, String channel, String interpolationType) {
                this.time = time;
